                ...
                <div class="container-fluid">
                    ...
                    <div class="row column1">
                        <div class="col-md-6 col-lg-3">
                            <div class="full counter_section margin_bottom_30 text-center">
                                ...
                                <div class="">
                                    <div>
                                        <p class="text-black font-weight-bold">{{ $adminCount }}</p>
                                        <p class="head_couter font-weight-bold">Admin</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="full counter_section margin_bottom_30 text-center">
                                <div class="couter_icon">
                                    <div>
                                        <i class="fa fa-users" style="color: lightblue;"></i>
                                    </div>
                                </div>
                                <div class="">
                                    <div>
                                        <p class="text-black font-weight-bold">{{ $assessorCount }}</p>
                                        <p class="head_couter font-weight-bold">Penguji</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="full counter_section margin_bottom_30 text-center">
                                <div class="couter_icon">
                                    <div>
                                        <i class="fa fa-mortar-board" style="color: purple;"></i>
                                    </div>
                                </div>
                                <div class="">
                                    <div>
                                        <p class="text-black font-weight-bold">{{ $studentCount }}</p>
                                        <p class="head_couter font-weight-bold">Siswa</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="full counter_section margin_bottom_30 text-center">
                                <div class="couter_icon">
                                    <div>
                                        <i class="fa fa-gears" style="color: gold;"></i>
                                    </div>
                                </div>
                                <div class="">
                                    <div>
                                        <p class="text-black font-weight-bold">{{ $majorCount }}</p>
                                        <p class="head_couter font-weight-bold">Jurusan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
