            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                    ...
                    <li><a href="/index/managestandard"><i class="fa fa-bars green_color"></i> <span>Standar Kompetensi</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
                ...
                <div class="row column1">
                    <div class="col-md-6 col-lg-6">
                        <div class="full counter_section margin_bottom_30 text-center">
                            ...
                            <div class="">
                                <div>
                                    <p class="text-black font-weight-bold">{{ $competencyStandards->count() }}</p>
                                    <p class="head_couter font-weight-bold">Kompetensi Standar</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="full counter_section margin_bottom_30 text-center">
                            ...
                            <div class="">
                                <div>
                                    <p class="text-black font-weight-bold">{{ $competencyElements->count() }}</p>
                                    <p class="head_couter font-weight-bold">Kompetensi Elemen</p>
                                </div>
                            </div>
                        </div>
                    </div>
